...
// The user must register before drawing
...
// OPENING THE CANVAS IN A NEW TAB
function myCanvasImg(){
    var myCanvas = document.getElementById("canvas");
    var canvasImg  = myCanvas.toDataURL("image/png");
    var tab = window.open('about:blank', '_blank');
    tab.document.write('<img src="'+canvasImg+'"/>'); 
    tab.document.close(); 
  }
  

document.getElementById("newTab").innerHTML += "<button class=\"btn btn-default\"  onclick='myCanvasImg();'>Open a new tab</button><br>";
